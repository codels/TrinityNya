...
public:
    ...
    class spell_dru_eclipse_energize_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_dru_eclipse_energize_SpellScript::HandleEnergize, EFFECT_0, 189);
        }
    };
...
class spell_dru_moonkin_form_passive : public SpellScriptLoader
{
    public:
        ...
        class spell_dru_moonkin_form_passive_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                 DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_dru_moonkin_form_passive_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_MOD_SHAPESHIFT);
