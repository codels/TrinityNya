...
class Mod_AutoLearn_PlayerScript : public PlayerScript
{
	...
	void learnSpellRogue()
	{
		...
		if (level < 16) return;
			...
			if (!character->HasSpell(1804)) character->learnSpell(1804, false); //Взлом замка 
			if (!character->HasSpell(6761) && character->HasSpell(2098)) character->learnSpell(6761, false); //Потрошение Уровень 3
			if (!character->HasSpell(1966)) character->learnSpell(1966, false); //Ложный выпад Уровень 1

			if (level < 18) return;

			if (!character->HasSpell(8676)) character->learnSpell(8676, false); //Внезапный удар Уровень 1

			if (level < 20) return;

			if (!character->HasSpell(2590) && character->HasSpell(53)) character->learnSpell(2590, false); //Удар в спину Уровень 3
			if (!character->HasSpell(1943)) character->learnSpell(1943, false); //Рваная рана Уровень 1
			//if (!character->HasSpell(1785)) character->learnSpell(1785, false); //Незаметность Уровень 2
			if (!character->HasSpell(51722)) character->learnSpell(51722, false); // unk

			if (level < 22) return;

			if (!character->HasSpell(1759) && character->HasSpell(1752)) character->learnSpell(1759, false); //Коварный удар Уровень 4
			if (!character->HasSpell(8631) && character->HasSpell(703)) character->learnSpell(8631, false); //Гаррота Уровень 2
			if (!character->HasSpell(1856)) character->learnSpell(1856, false); //Исчезновение Уровень 1
			if (!character->HasSpell(1725)) character->learnSpell(1725, false); //Отвлечение 

			if (level < 24) return;

			if (!character->HasSpell(6762) && character->HasSpell(2098)) character->learnSpell(6762, false); //Потрошение Уровень 4
			if (!character->HasSpell(2836)) character->learnSpell(2836, false); //Обнаружение ловушек Пассивная

			if (level < 26) return;

			if (!character->HasSpell(1833)) character->learnSpell(1833, false); //Подлый трюк 
			//if (!character->HasSpell(8649)) character->learnSpell(8649, false); //Ослабление доспеха Уровень 2
			if (!character->HasSpell(8724) && character->HasSpell(8676)) character->learnSpell(8724, false); //Внезапный удар Уровень 2

			if (level < 28) return;

			if (!character->HasSpell(6768) && character->HasSpell(1966)) character->learnSpell(6768, false); //Ложный выпад Уровень 2
			if (!character->HasSpell(2070) && character->HasSpell(6770)) character->learnSpell(2070, false); //Ошеломление Уровень 2
			if (!character->HasSpell(8639) && character->HasSpell(1943)) character->learnSpell(8639, false); //Рваная рана Уровень 2
			if (!character->HasSpell(2591) && character->HasSpell(53)) character->learnSpell(2591, false); //Удар в спину Уровень 4

			if (level < 30) return;

			if (!character->HasSpell(8632) && character->HasSpell(703)) character->learnSpell(8632, false); //Гаррота Уровень 3
			if (!character->HasSpell(408)) character->learnSpell(408, false); //Удар по почкам Уровень 1
			if (!character->HasSpell(1842)) character->learnSpell(1842, false); //Обезвреживание ловушки 
			if (!character->HasSpell(1760) && character->HasSpell(1752)) character->learnSpell(1760, false); //Коварный удар Уровень 5

			if (level < 32) return;

			if (!character->HasSpell(8623) && character->HasSpell(2098)) character->learnSpell(8623, false); //Потрошение Уровень 5

			if (level < 34) return;

			if (!character->HasSpell(8696) && character->HasSpell(2983)) character->learnSpell(8696, false); //Спринт Уровень 2
			if (!character->HasSpell(2094)) character->learnSpell(2094, false); //Ослепление 
			if (!character->HasSpell(8725) && character->HasSpell(8676)) character->learnSpell(8725, false); //Внезапный удар Уровень 3

			if (level < 36) return;

			if (!character->HasSpell(8640) && character->HasSpell(1943)) character->learnSpell(8640, false); //Рваная рана Уровень 3
			if (!character->HasSpell(8721) && character->HasSpell(53)) character->learnSpell(8721, false); //Удар в спину Уровень 5
			//if (!character->HasSpell(8650)) character->learnSpell(8650, false); //Ослабление доспеха Уровень 3

			if (level < 38) return;

			if (!character->HasSpell(8621) && character->HasSpell(1752)) character->learnSpell(8621, false); //Коварный удар Уровень 6
			if (!character->HasSpell(8633) && character->HasSpell(703)) character->learnSpell(8633, false); //Гаррота Уровень 4

			if (level < 40) return;

			if (!character->HasSpell(8637) && character->HasSpell(1966)) character->learnSpell(8637, false); //Ложный выпад Уровень 3
			if (!character->HasSpell(1860)) character->learnSpell(1860, false); //Безопасное падение Пассивная
			if (!character->HasSpell(8624) && character->HasSpell(2098)) character->learnSpell(8624, false); //Потрошение Уровень 6
			//if (!character->HasSpell(1786)) character->learnSpell(1786, false); //Незаметность Уровень 3

			if (level < 42) return;

			if (!character->HasSpell(11267) && character->HasSpell(8676)) character->learnSpell(11267, false); //Внезапный удар Уровень 4
			if (!character->HasSpell(6774) && character->HasSpell(5171)) character->learnSpell(6774, false); //Мясорубка Уровень 2
			if (!character->HasSpell(1857) && character->HasSpell(1856)) character->learnSpell(1857, false); //Исчезновение Уровень 2

			if (level < 44) return;

			if (!character->HasSpell(11273) && character->HasSpell(1943)) character->learnSpell(11273, false); //Рваная рана Уровень 4
			if (!character->HasSpell(11279) && character->HasSpell(53)) character->learnSpell(11279, false); //Удар в спину Уровень 6

			if (level < 46) return;

			if (!character->HasSpell(17347) && character->HasSpell(16511)) character->learnSpell(17347, false); //Кровоизлияние Уровень 2
			if (!character->HasSpell(11289) && character->HasSpell(703)) character->learnSpell(11289, false); //Гаррота Уровень 5
			//if (!character->HasSpell(11197)) character->learnSpell(11197, false); //Ослабление доспеха Уровень 4
			if (!character->HasSpell(11293) && character->HasSpell(1752)) character->learnSpell(11293, false); //Коварный удар Уровень 7
			
			if (level < 48) return;

			if (!character->HasSpell(11297) && character->HasSpell(6770)) character->learnSpell(11297, false); //Ошеломление Уровень 3
			if (!character->HasSpell(11299) && character->HasSpell(2098)) character->learnSpell(11299, false); //Потрошение Уровень 7

			if (level < 50) return;

			if (!character->HasSpell(8643) && character->HasSpell(408)) character->learnSpell(8643, false); //Удар по почкам Уровень 2
			if (!character->HasSpell(26669) && character->HasSpell(5277)) character->learnSpell(26669, false); //Ускользание Уровень 2
			if (!character->HasSpell(34411) && character->HasSpell(1329)) character->learnSpell(34411, false); //Расправа Уровень 2
			if (!character->HasSpell(11268) && character->HasSpell(8676)) character->learnSpell(11268, false); //Внезапный удар Уровень 5

			if (level < 52) return;
			
			if (!character->HasSpell(11303) && character->HasSpell(1966)) character->learnSpell(11303, false); //Ложный выпад Уровень 4
			if (!character->HasSpell(11274) && character->HasSpell(1943)) character->learnSpell(11274, false); //Рваная рана Уровень 5
			if (!character->HasSpell(11280) && character->HasSpell(53)) character->learnSpell(11280, false); //Удар в спину Уровень 7

			if (level < 54) return;

			if (!character->HasSpell(11290) && character->HasSpell(703)) character->learnSpell(11290, false); //Гаррота Уровень 6
			if (!character->HasSpell(11294) && character->HasSpell(1752)) character->learnSpell(11294, false); //Коварный удар Уровень 8

			if (level < 56) return;
			
			if (!character->HasSpell(11300) && character->HasSpell(2098)) character->learnSpell(11300, false); //Потрошение Уровень 8
			//if (!character->HasSpell(11198)) character->learnSpell(11198, false); //Ослабление доспеха Уровень 5

			if (level < 58) return;

			if (!character->HasSpell(11305) && character->HasSpell(2983)) character->learnSpell(11305, false); //Спринт Уровень 3
			if (!character->HasSpell(11269) && character->HasSpell(8676)) character->learnSpell(11269, false); //Внезапный удар Уровень 6
			if (!character->HasSpell(17348) && character->HasSpell(16511)) character->learnSpell(17348, false); //Кровоизлияние Уровень 3

			if (level < 60) return;

			//if (!character->HasSpell(1787)) character->learnSpell(1787, false); //Незаметность Уровень 4
			if (!character->HasSpell(31016) && character->HasSpell(2098)) character->learnSpell(31016, false); //Потрошение Уровень 9
			if (!character->HasSpell(25302) && character->HasSpell(1966)) character->learnSpell(25302, false); //Ложный выпад Уровень 5
			if (!character->HasSpell(25300) && character->HasSpell(53)) character->learnSpell(25300, false); //Удар в спину Уровень 9
			if (!character->HasSpell(11281) && character->HasSpell(53)) character->learnSpell(11281, false); //Удар в спину Уровень 8
			if (!character->HasSpell(34412) && character->HasSpell(1329)) character->learnSpell(34412, false); //Расправа Уровень 3
			if (!character->HasSpell(11275) && character->HasSpell(1943)) character->learnSpell(11275, false); //Рваная рана Уровень 6
