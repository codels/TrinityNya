...
template<class T>
void AchievementMgr<T>::SaveToDB(SQLTransaction& /*trans*/, bool account)
{
}

template<>
void AchievementMgr<Player>::SaveToDB(SQLTransaction& trans, bool account)
{
...
template<class T>
void AchievementMgr<T>::LoadFromDB(PreparedQueryResult achievementResult, PreparedQueryResult criteriaResult, bool account)
{
}

template<>
void AchievementMgr<Player>::LoadFromDB(PreparedQueryResult achievementResult, PreparedQueryResult criteriaResult, bool account)
{
